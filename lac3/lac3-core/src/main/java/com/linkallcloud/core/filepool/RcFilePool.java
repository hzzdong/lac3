package com.linkallcloud.core.filepool;
...
public class RcFilePool implements FilePool {

    private static final Log log = Logs.get();

    public RcFilePool(String homePath) {
        this(homePath, 0);
    }

    public RcFilePool(String homePath, long size) {
