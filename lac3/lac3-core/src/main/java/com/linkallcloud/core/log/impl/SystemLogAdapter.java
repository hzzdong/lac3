...
import com.linkallcloud.core.log.LogAdapter;
...
public class SystemLogAdapter implements LogAdapter, Plugin {
    ...
    public static class SystemLog extends AbstractLog {
		private static final long serialVersionUID = 4068610953841023430L;
        ...
        static SystemLog me() {
            if (! warned) {
                me.info("Select SystemLog as LAC.Log implement");
                warned = true;
            }
            return me;
        }
