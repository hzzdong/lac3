package com.linkallcloud.core.castor;
...
import com.linkallcloud.core.castor.castor.Object2Object;
import com.linkallcloud.core.castor.castor.*;
import com.linkallcloud.core.lang.Lang;
import com.linkallcloud.core.lang.Mirror;
import com.linkallcloud.core.lang.TypeExtractor;
...
public class Castors {
     ...
     * 设置转换的配置
     * <p>
     * 配置对象所有的共有方法都会被遍历。只要这个方法有一个且只有一个参数，并且该参数 是一个 com.linkallcloud.castor.Castor
    ...
    static {
        ...
        defaultCastorList.add(Boolean2Boolean.class);
        ...
        defaultCastorList.add(Map2Boolean.class);
        ...
        defaultCastorList.add(Object2Boolean.class);
