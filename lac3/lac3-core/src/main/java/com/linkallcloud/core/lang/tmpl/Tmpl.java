...
public class Tmpl {
    ...
    /**
     * @see #exec(String, Pattern, int, int, RcBean, boolean)
     */
    public static String exec(String tmpl, RcBean context) {
     ...
     * @see #exec(String, Pattern, int, int, RcBean, boolean)
     */
    public static String exec(String tmpl, RcBean context, boolean showKey) {
    ...
    public String render(RcBean context) {
        return render(context, true);
    }

    public String render(RcBean context, boolean showKey) {
