...
public class Domains {
     ...
     * @return
     */
    public static <E extends Domain, V extends Vo> V castDomain2Vo(E domain,
                                                                   Class<V> classV) {
     ...
     * @return DTO列表
     */
    public static <E extends Domain, V extends Vo> List<V> castDomains2Vos(List<E> domains,
                                                                           Class<V> classOfDTO) {
    ...
    public static <E extends Domain, V extends Vo> List<V> castDomains2DTOs(
     ...
     * @return
     */
    public static <E extends Domain, V extends Vo> List<E> castVos2Domains(List<V> vos,
                                                                           Class<E> classE) {
