...
public class Domains {
	 ...
	 * @return
	 */
	public static <PK extends Serializable> boolean exist(PK existId, List<? extends Domain<PK>> doms) {
		if (existId != null && doms != null && !doms.isEmpty()) {
			for (Domain<PK> role : doms) {
				if (role.getId().equals(existId)) {
					return true;
				}
			}
		}
	...
	public static <PK extends Serializable, T extends Domain<PK>> List<PK> getIds(List<T> doms) {
		List<PK> ids = new ArrayList<PK>();
	 ...
	 * @return
	 */
	public static <PK extends Serializable, E extends Domain<PK>, V extends Vo> V castDomain2Vo(E domain,
                                                                                                Class<V> classV) {
	 ...
	 */
	public static <PK extends Serializable, E extends Domain<PK>, V extends Vo> V castDomain2Vo(E domain,
			Class<V> classV, Object[] createArgs) {
	 ...
	 */
	public static <PK extends Serializable, E extends Domain<PK>, V extends Vo> V castDomain2Vo(E domain,
			Class<V> classV, String methodName, Object[] createArgs) {
	 ...
	 * @return
	 */
	public static <PK extends Serializable, E extends Domain<PK>, V extends Vo> E castVo2Domain(V vo, Class<E> classe) {
	 ...
	 * @return DTO列表
	 */
	public static <PK extends Serializable, E extends Domain<PK>, V extends Vo> List<V> castDomains2Vos(List<E> domains,
			Class<V> classOfDTO) {
	 ...
	 */
	public static <PK extends Serializable, E extends Domain<PK>, V extends Vo> List<V> castDomains2Vos(List<E> domains,
			Class<V> classOfDTO, Object[] createArgs) {
	...
	public static <PK extends Serializable, E extends Domain<PK>, V extends Vo> List<V> castDomains2DTOs(
			List<E> domains, Class<V> classV, String methodName, Object[] createArgs) {
		List<V> vos = null;
	 ...
	 * @return
	 */
	public static <PK extends Serializable, E extends Domain<PK>, V extends Vo> List<E> castVos2Domains(List<V> vos,
			Class<E> classE) {
	 ...
	 */
	public static <PK extends Serializable, E extends Domain<PK>, V extends Vo> List<E> castVos2Domains(List<V> vos,
			Class<E> classE, Object[] createArgs) {
	...
	@SuppressWarnings("unchecked")
	public static <PK extends Serializable, E extends Domain<PK>, V extends Vo> List<E> castVos2Domains(List<V> vos,
			Class<E> classE, String methodName, Object[] createArgs) {
		List<E> domains = null;
