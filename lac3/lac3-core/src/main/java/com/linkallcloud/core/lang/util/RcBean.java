...
public interface RcBean extends Map<String, Object> {
    ...
    RcBean addv(String key, Object value);

    RcBean setv(String key, Object value);

    void unset(String key);

    RcBean setAll(Map<String, Object> map);
     ...
     * @return 新 Map
     */
    RcBean pickAndRemove(String... keys);
     ...
     * @return 新 Map
     */
    RcBean pickBy(Pattern p, boolean isNot);
     ...
     * @return 新 Map
     */
    RcBean pickAndRemoveBy(Pattern p, boolean isNot);
     ...
     * @return 自身以便链式赋值
     */
    RcBean putDefault(String key, Object dft);

    RcBean setMap(Map<?, ?> map, boolean ignoreNullValue);
     ...
     */
    RcBean mergeWith(Map<String, Object> map);
     ...
     * @return 自身以便链式赋值
     */
    RcBean mergeWith(Map<String, Object> map, boolean onlyAbsent);
     ...
     * @return 当前实例
     */
    RcBean setnx(String key, Object val);
     ...
     */
    RcBean setnxAll(Map<String, Object> map);
