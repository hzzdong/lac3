...
public class HttpClientFactory {
    ...
    public String get(String url, Integer timeout, Map<String, String> httpHeaders, String proxyHost, int proxyPort) {
        try {
            return doExcuteGet(url, timeout, httpHeaders, proxyHost, proxyPort);
        } catch (IOException e) {//重试一次
            try {
                return doExcuteGet(url, timeout, httpHeaders, proxyHost, proxyPort);
    ...
    private String doExcuteGet(String url, Integer timeout, Map<String, String> httpHeaders, String proxyHost, int proxyPort) throws IOException {
...
//			}
    ...
    public String post(String url, String message, Integer timeout) {
        try {
            return doExcutePost(url, message, timeout);
        } catch (IOException e) {//重试一次
            try {
                return doExcutePost(url, message, timeout);
            } catch (IOException e2) {
    ...
    private String doExcutePost(String url, String message, Integer timeout) throws IOException {
...
//				}
    ...
    public String post(String url, List<BasicNameValuePair> parametersList, Integer timeout, String proxyHost,
                       int proxyPort) {
        try {
            return doExcutePost(url, parametersList, timeout, proxyHost, proxyPort);
        } catch (Throwable e) {//重试一次
            try {
                return doExcutePost(url, parametersList, timeout, proxyHost, proxyPort);
            } catch (Throwable e2) {
                throw new BaseRuntimeException("499", "HTTP请求错误");
    ...
    private String doExcutePost(String url, List<BasicNameValuePair> parametersList, Integer timeout, String proxyHost,
