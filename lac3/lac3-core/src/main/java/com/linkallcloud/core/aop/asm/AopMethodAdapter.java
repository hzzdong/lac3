...
import com.linkallcloud.core.repo.org.objectweb.asm.Attribute;
...
class AopMethodAdapter extends NormalMethodAdapter implements Opcodes {
    ...
    private static final String RC_AOP_INTERCEPTOR_CHAIN = "com/linkallcloud/core/aop/InterceptorChain";
    ...
    void enhandMethod_Void() {
        ...
        mv.visitLabel(l0);
        mv.visitTypeInsn(NEW, RC_AOP_INTERCEPTOR_CHAIN);
        mv.visitInsn(DUP);
        visitX(methodIndex);
        ...
        mv.visitMethodInsn(    INVOKEVIRTUAL,
                            RC_AOP_INTERCEPTOR_CHAIN,
                            "doChain",
                            "()Lcom/linkallcloud/aop/InterceptorChain;",
                            false);
