...
import com.linkallcloud.core.aop.DefaultClassDefiner;
import com.linkallcloud.core.lang.Lang;
import com.linkallcloud.core.repo.org.objectweb.asm.ClassWriter;
...
import com.linkallcloud.core.repo.org.objectweb.asm.commons.GeneratorAdapter;
...
public class FastMethodFactory implements Opcodes {
    ...
    protected static com.linkallcloud.core.repo.org.objectweb.asm.commons.Method _M;
    protected static Type Exception_TYPE;
    static {
    ...
    public static byte[] _make(Class<?> klass,
                               int mod,
                               Class<?>[] params,
                               com.linkallcloud.core.repo.org.objectweb.asm.commons.Method method,
                               Class<?> returnType,
                               String className,
                               String descriptor) {
        ...
        // 首先, 定义默认构造方法
        addConstructor(cw, Type.getType(Object.class), com.linkallcloud.core.repo.org.objectweb.asm.commons.Method.getMethod("void <init> ()"));
    ...
    public static com.linkallcloud.core.repo.org.objectweb.asm.commons.Method _Method(String name, String desc) {
        return new com.linkallcloud.core.repo.org.objectweb.asm.commons.Method(name, desc);
    }

    public static com.linkallcloud.core.repo.org.objectweb.asm.commons.Method _Method(Method method) {
        return com.linkallcloud.core.repo.org.objectweb.asm.commons.Method.getMethod(method);
    }

    public static com.linkallcloud.core.repo.org.objectweb.asm.commons.Method _Method(String method) {
        return com.linkallcloud.core.repo.org.objectweb.asm.commons.Method.getMethod(method);
    }

    private static com.linkallcloud.core.repo.org.objectweb.asm.commons.Method _Method(Constructor<?> constructor) {
        return com.linkallcloud.core.repo.org.objectweb.asm.commons.Method.getMethod(constructor);
    }

    public static void addConstructor(ClassWriter cw,
                                      Type parent,
                                      com.linkallcloud.core.repo.org.objectweb.asm.commons.Method m) {
