...
//        System.out.println(flag3 ? "HTTP服务启动..." : "HTTP服务关闭...");
        ...
        boolean flag8 = isHealth("http://47.96.234.18/sso/login?service=http%3A%2F%2Flocalhost%2Fiapi%2Fssoauth%3Fredirect%3Dhttp%253A%252F%252Flocalhost%252Flac3-de-view-pc%252Fpage%252Fhome.html&from=lac_app_de&clazz=0");
    ...
    public static Integer getIntegerMax(Integer... values) {
        List<Integer> list = Arrays.asList(values);
        Integer max = Collections.max(list);
        return max;
    }

    public static Integer getIntegerMin(Integer... values) {
        List<Integer> list = Arrays.asList(values);
