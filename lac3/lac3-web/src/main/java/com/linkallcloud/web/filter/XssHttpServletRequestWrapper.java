...
public class XssHttpServletRequestWrapper extends HttpServletRequestWrapper {
    ...
    public static void main(String[] args) {
        String input = "I like Java,jAva is <SCRIPT> function(){alert(1)}</script> jaVa is so popular.";
        String replacement = "AAA";

        System.out.println(input);
        System.out.println(input.replaceAll("(?i)<script>(.*?)</script>", replacement));
    }
    ...
    private static String cleanXSS(String value) {
        ...
        value = value.replaceAll("(?i)e­xpression\\((.*?)\\)", "");
